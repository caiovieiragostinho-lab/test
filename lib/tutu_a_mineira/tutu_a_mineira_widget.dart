...
class TutuAMineiraWidget extends StatefulWidget {
  ...
  static String routeName = 'Tutu-a-Mineira';
              ...
              Column(
                ...
                children: [
                  Align(
                    ...
                    child: Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(90.0, 20.0, 0.0, 0.0),
                      child: Text(
                        'Tutu á Mineira',
                        style:
                  ...
                  Align(
                    ...
                    child: Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(20.0, 7.0, 20.0, 0.0),
                      child: Text(
                        'O Tutu á Mineira é feito com feijão batido e engrossado com farinha de mandioca , formando um creme consistente  e bem temperado. Leva ingredientes como alho, bacon e linguiça , e costuma ser servido com arroz, couve e torresmo.',
                        textAlign: TextAlign.justify,
                        style: FlutterFlowTheme.of(context).titleLarge.override(
                              font: GoogleFonts.interTight(
                                fontWeight: FlutterFlowTheme.of(context)
